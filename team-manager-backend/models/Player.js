...
const playerSchema = new mongoose.Schema({
  ...
  birthDate: { type: Date, required: false }, // Geburtsdatum
  ...
  position: { type: String, required: false }, // Position des Spielers (z.B. "Torwart", "Verteidiger")
  jerseyNumber: { type: Number, required: false }, // Trikotnummer
